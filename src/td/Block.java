...
public abstract class Block {
    ...
    public int distance(Block b) {
        int r=Math.abs(this.getRow()-b.getRow());
        int pp=Math.abs(this.getCol()-b.getCol());
        int sum=r+pp;
        //TODO
    return sum;}
    public int distance(int b, int c){
        int r=Math.abs(this.getRow()-b);
        int pp=Math.abs(this.getCol()-c);
        int sum=r+pp;
        return sum;
    }
    /**
